...
/**
 * Get/sets a validater function 
 * @param  {String}   name
 * @param  {Function} fn
 * @return {Schema} Returns self for chaining
 */
Schema.prototype.validater = function(name, fn) {
  if (fn === undefined) return this.validaters[name]
  else this.validaters[name] = fn
  return this
}

Schema.prototype.rule = Schema.prototype.validater

function extend(ctor) {
  // Generic static functions
  ;(['filter', 'validater', 'validate', 'rule', 'sanitize', 'cast'])
    .forEach(function(fn) {
      ctor[fn] = function (arg1, arg2, arg3) {
        return this.prototype[fn](arg1, arg2, arg3)
      }
    })
  return ctor
}
...
function default_ctor() {
  return function (options, key, parent) {
